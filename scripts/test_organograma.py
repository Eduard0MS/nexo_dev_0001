...
class OrganogramaTestCase(unittest.TestCase):
    ...
    def test_1_criar_departamentos(self):
        ...
        # Criar departamentos
        departamentos = [
            Departamento.objects.create(nome="Diretoria", descricao="Diretoria executiva"),
            Departamento.objects.create(nome="Recursos Humanos", descricao="Gestão de pessoal"),
            Departamento.objects.create(nome="Financeiro", descricao="Gestão financeira"),
            Departamento.objects.create(nome="TI", descricao="Tecnologia da Informação"),
            Departamento.objects.create(nome="Marketing", descricao="Marketing e comunicação")
        ]
        
        # Configurar hierarquia
        departamentos[1].departamento_pai = departamentos[0]  # RH subordinado à Diretoria
        departamentos[1].save()
        
        departamentos[2].departamento_pai = departamentos[0]  # Financeiro subordinado à Diretoria
        departamentos[2].save()
        
        departamentos[3].departamento_pai = departamentos[0]  # TI subordinado à Diretoria
        departamentos[3].save()
        
        departamentos[4].departamento_pai = departamentos[0]  # Marketing subordinado à Diretoria
    ...
    def test_3_editar_departamento(self):
        ...
        self.assertEqual(departamento_atualizado.descricao, "Suporte técnico e desenvolvimento de sistemas")
    ...
    def test_7_mover_funcionario(self):
        ...
        gerente_destino = Funcionario.objects.get(cargo__nome="Gerente", supervisor__isnull=False).supervisor
