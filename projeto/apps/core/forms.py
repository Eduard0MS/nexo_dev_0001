...
class CustomRegisterForm(UserCreationForm):
    ...
    def clean_password1(self):
        ...
        common_passwords = [
            "password", "123456", "12345678", "qwerty", "abc123", "admin123",
            "welcome", "senha123", "admin", "123mudar", "1234", "12345", "123456789",
            "test123", "usuario", "q1w2e3r4", "qwerty123", "1q2w3e", "abcd1234"
        ]
        
        # Verificar se a senha é comum
        if password.lower() in common_passwords:
            raise forms.ValidationError("Esta senha é muito comum. Por favor, escolha uma senha mais segura.")
...
class CustomPasswordChangeForm(PasswordChangeForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["old_password"].widget.attrs.update(
            {"class": "form-control", "placeholder": "Senha atual", "id": "old_password"}
        )
        self.fields["new_password1"].widget.attrs.update(
            {"class": "form-control", "placeholder": "Nova senha", "id": "new_password1"}
        )
        self.fields["new_password2"].widget.attrs.update(
            {"class": "form-control", "placeholder": "Confirme a nova senha", "id": "new_password2"}
        )
