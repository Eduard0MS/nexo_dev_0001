    ...
    def handle(self, *args, **options):
        ...
        for unidade in unidades:
            ...
            if atualizadas % 100 == 0:
                self.stdout.write(f"Processadas {atualizadas}/{total_unidades} unidades")

        self.stdout.write(self.style.SUCCESS(f'Processo concluído! {atualizadas} unidades atualizadas.')) 